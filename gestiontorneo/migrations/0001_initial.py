    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_partido', models.CharField(choices=[('pendiente', 'Pendiente'), ('en_curso', 'En curso'), ('jugado', 'Jugado')], default='pendiente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bye1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partidos_bye1', to='gestiontorneo.jugadorbye')),
                ('bye2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partidos_bye2', to='gestiontorneo.jugadorbye')),
                ('ganador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partidos_ganados', to='gestiontorneo.jugador')),
                ('jugador1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partidos_jugador1', to='gestiontorneo.jugador')),
                ('jugador2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partidos_jugador2', to='gestiontorneo.jugador')),
                ('llave_torneo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos', to='gestiontorneo.llavetorneo')),
                ('organizador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos_organizados', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Resultado',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sets_jugador_1', models.PositiveIntegerField(default=0)),
                ('sets_jugador_2', models.PositiveIntegerField(default=0)),
                ('resultado_jugador_1', models.DecimalField(blank=True, decimal_places=3, max_digits=5, null=True)),
                ('resultado_jugador_2', models.DecimalField(blank=True, decimal_places=3, max_digits=5, null=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
                ('partido', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='resultado', to='gestiontorneo.partido')),
            ],
        ),
        migrations.CreateModel(
            name='Torneo',
            fields=[
                ...
                ('mejor_de_sets', models.PositiveIntegerField(choices=[(1, 'Mejor de 1 set'), (3, 'Mejor de 3 sets'), (5, 'Mejor de 5 sets'), (7, 'Mejor de 7 sets'), (9, 'Mejor de 9 sets')], default=3)),
                ('mejor_de_sets_final', models.PositiveIntegerField(choices=[(1, 'Mejor de 1 set'), (3, 'Mejor de 3 sets'), (5, 'Mejor de 5 sets'), (7, 'Mejor de 7 sets'), (9, 'Mejor de 9 sets')], default=5)),
        ...
        migrations.AddField(
            model_name='partido',
            name='torneo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos', to='gestiontorneo.torneo'),
        ),
        migrations.AddField(
            model_name='llavetorneo',
            name='torneo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='llaves', to='gestiontorneo.torneo'),
        ),
        migrations.AddField(
            model_name='jugadorbye',
            name='torneo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='byes', to='gestiontorneo.torneo'),
        ),
        migrations.CreateModel(
            name='GrupoTorneo',
            fields=[
